...
const steps = [
  ...
  { number: 3, title: "I already teach people how to build with AI" },
];
...
export function WhyMichelleStepRail() {
  ...
  return (
    <nav aria-label="Why Michelle points" className="mt-7">
        ...
        {steps.map(({ number, title }) => (
          <li key={number}>
            <a
              ...
              aria-label={`Go to Why Michelle point ${number}`}
            ...
            >
              <Image
                src={`/begin/chalk-numbers/chalk-circled-${number}.png`}
                alt=""
                width={512}
                height={512}
                aria-hidden="true"
